 ...
 *   https://datatables.net/download/#dt/dt-2.1.2/b-3.1.0/cr-2.0.3/date-1.5.3/rr-1.5.0
 *
 * Included libraries:
 *   DataTables 2.1.2, Buttons 3.1.0, ColReorder 2.0.3, DateTime 1.5.3, RowReorder 1.5.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.2/b-3.1.0/cr-2.0.3/date-1.5.3/rr-1.5.0",
